...
class AdministratorController extends Controller
{
    ...
    public function store(UserRequest $request)
    {
        ...
        $administrator = Administrator::where("id", $administrator->id)->with("user")->first();

        return $administrator ? $this->successResponse($administrator, __('Se ha realizado con exito el registro')) : $this->customValidationErrorResponse(['general' => [__('Algo salió mal al generar el usuario.')]], __('Algo salió mal'));
    }
    ...
    {
        $administrator = Administrator::where("id", $id)->with("user")->first();
        return new UserResource($administrator);
    }
